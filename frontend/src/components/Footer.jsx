    ...
    <footer className="bg-gray-900 text-white">
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {/* Brand */}
          <div>
            <h3 className="text-2xl font-bold text-primary mb-4">{settings.store_name || 'Avisander'}</h3>
            ...
            <ul className="space-y-3">
              <li className="flex items-start space-x-3">
                ...
                <span className="text-gray-400">
                  {settings.store_address || 'Bucaramanga, Santander'}
                </span>
              </li>
              <li>
                <a
          ...
          <div>
            ...
            <ul className="space-y-2 text-gray-400">
              ...
              <li className="ml-8">{settings.business_hours_weekday}</li>
              <li className="ml-8 mt-2">Domingos</li>
              <li className="ml-8">{settings.business_hours_weekend}</li>
            </ul>
          </div>
        </div>

        <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-500">
          <p>&copy; {new Date().getFullYear()} {settings.store_name || 'Avisander'}. Todos los derechos reservados.</p>
        </div>
      </div>
    </footer>
  )
