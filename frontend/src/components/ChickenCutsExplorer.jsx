...
const CUTS = [
  {
    ...
    exploded: { x: 0, y: -38, rotate: -4, scale: 0.5 },
    searchTerm: 'pechuga'
  },
  {
    id: 'alas',
    ...
    exploded: { x: -38, y: -5, rotate: -12, scale: 0.45 },
    searchTerm: 'alas'
  },
  {
    id: 'muslos',
    ...
    exploded: { x: -30, y: 32, rotate: 8, scale: 0.48 },
    searchTerm: 'muslo'
  },
  {
    id: 'piernas',
  ...
  },
  {
    ...
    exploded: { x: 38, y: -18, rotate: 14, scale: 0.45 },
